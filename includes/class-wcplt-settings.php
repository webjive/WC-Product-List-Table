...
class WCPLT_Settings extends WC_Settings_Page {
    ...
    private function get_layout_settings() {
        return array(
            ...
            array(
                'title' => __( 'Typography Settings', 'wc-product-list-table' ),
                'type'  => 'title',
                'desc'  => __( 'Customize font sizes for product list elements', 'wc-product-list-table' ),
                'id'    => 'wcplt_typography_settings',
            ),
            array(
                'title'    => __( 'Use Default Theme Font', 'wc-product-list-table' ),
                'desc'     => __( 'Use the default theme font family instead of custom styling', 'wc-product-list-table' ),
                'id'       => 'wcplt_use_default_font',
                'default'  => 'yes',
                'type'     => 'checkbox',
            ),
            array(
                'title'       => __( 'Product Title Font Size', 'wc-product-list-table' ),
                'desc'        => __( 'Font size for product titles (e.g., 1.2em, 18px, 16pt). Leave empty for theme default.', 'wc-product-list-table' ),
                'id'          => 'wcplt_title_font_size',
                'default'     => '',
                'type'        => 'text',
                'css'         => 'width: 150px;',
            ...
            array(
                'title'       => __( 'Short Description Font Size', 'wc-product-list-table' ),
                'desc'        => __( 'Font size for product short descriptions (e.g., 0.95em, 14px). Leave empty for theme default.', 'wc-product-list-table' ),
                'id'          => 'wcplt_short_desc_font_size',
                'default'     => '',
                'type'        => 'text',
                'css'         => 'width: 150px;',
                'placeholder' => 'e.g., 0.95em',
            ),
            array(
                'title'       => __( 'Price Font Size', 'wc-product-list-table' ),
                'desc'        => __( 'Font size for product prices (e.g., 1.5em, 20px). Leave empty for theme default.', 'wc-product-list-table' ),
                'id'          => 'wcplt_price_font_size',
                'default'     => '',
                'type'        => 'text',
                'css'         => 'width: 150px;',
